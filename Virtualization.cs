...
//{
//    class Virtualization : Protection
//    {
//        public const string _Id = "virtualization";
//        public const string _FullId = "Ki.Virt";

//        public override string Name
//        {
//            get { return "DynamicMethod-Virt"; }
//        }

//        public override string Description
//        {
//            get { return "This protection fuck yourself."; }
//        }
...
//        {
//            pipeline.InsertPreStage(PipelineStage.ProcessModule, new VirtualizationPhase(this));
//        }
//        class VirtualizationPhase : ProtectionPhase
//        {
//            public VirtualizationPhase(Virtualization parent)
//            : base(parent) { }
...
//            public override string Name
//            {
//                get { return "Virt injection"; }
//            }
//            protected override void Execute(ConfuserContext context, ProtectionParameters parameters)
//            {
//                AssemblyDef ctx = context.CurrentModule.Assembly;
//                Utils.LoadOpCodes();
//                Utils2.LoadOpCodes();
//                //List<Instruction> final = new List<Instruction>();
//                //final.Add(OpCodes.Ldstr.ToInstruction("abc"));
//                //final.Add(OpCodes.Call.ToInstruction(ctx.ManifestModule.Import(typeof(Console).GetMethod("WriteLine", new Type[] { typeof(string) }))));
//                //final.Add(OpCodes.Ret.ToInstruction());
//                //Emulate(final.ToArray(), ctx);
//                foreach (TypeDef type in ctx.ManifestModule.Types)
//                    foreach (MethodDef method in type.Methods)
//                    {
//                        if (!method.HasBody) continue;
//                        if (!method.Body.HasInstructions) continue;
//                        if (method.ReturnType.TypeName != "Void") continue;
//                        if (type.Namespace == "") continue;
//                        if (type.Namespace.Contains(".Properties")) continue;
//                        //if (method.Name == "Dispose") {Console.WriteLine(string.Format("{0} Ignored, not compatible", method.Name)) ;continue; };
//                        for (int e = 0; e < method.Body.Instructions.Count; e++)
//                            if (method.Body.Instructions[e].OpCode.OperandType == OperandType.InlineBrTarget || method.Body.Instructions[e].OpCode.OperandType == OperandType.ShortInlineBrTarget)
//                            {
//                                context.Logger.Warn(string.Format("{0} Ignored, not compatible", method.Name));
//                                goto endest;
//                            }
//                        if (type.IsGlobalModuleType && method.Name == ".cctor") continue;
...
//                    }
//                }
//                lista.Add(OpCodes.Ldstr.ToInstruction("Krawk"));
...
//            {
//                DynamicMethod emulatore = new DynamicMethod("Krawk", typeof(void), null);
